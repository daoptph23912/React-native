...
import { getAllBackground, getBackgroundWithId } from "../api/BackgroundApi";
...
const UpdatePost = ({navigation,route}) => {
  ...
  const [currentImg, setCurrentImg] = useState(route.params.post.img);
  ...
  const getBackgrounds = async () => {
    ...
    setCurrentBg(await getBackgroundWithId(route.params.post.backgroundId));
  };
  ...
  const update = () => {
    ...
    updatePost(route.params.post.id,post);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.postsBtn} onPress={update}>
          <Text
